...
function squash {
  ...
  ${HOME}/Library/Python/2.7/bin/docker-squash -f $base ${IMAGE_NAME} -t ${IMAGE_NAME}
}
...
for dir in ${dirs}; do
  ...
  # Thanks, http://stackoverflow.com/questions/3601515/how-to-check-if-a-variable-is-set-in-bash
  # FYI, -v isn't available in mac bash
